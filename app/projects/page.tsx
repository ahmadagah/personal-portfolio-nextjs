export default function ProjectsPage() {
  const projects = [
    ...
    },
    {
      ...
      techStack: ["Vue.js", "OpenWeatherMap API", "Bootstrap"],
    },
    {
    ...
    },
    {
      ...
      techStack: ["Flutter", "Firebase", "Chart.js"],
    },
    {
    ...
    },
    {
      ...
      techStack: ["Ruby on Rails", "React", "AWS S3"],
    },
    {
      title: "Food Delivery App",
      description: "A mobile app for ordering food from local restaurants.",
      techStack: ["Swift", "Firebase", "Stripe API"],
    },
    {
      title: "Travel Blog Website",
      description:
        "A blog platform for sharing travel experiences with an integrated map view.",
      techStack: ["Gatsby", "GraphQL", "Tailwind CSS"],
    },
    {
      title: "AI Chatbot",
      description:
    ...
    },
    {
      ...
      techStack: ["Express.js", "React", "AWS Media Services"],
    },
  ];
